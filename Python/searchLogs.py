...
CDTname = "CDT-20211005-145513.zip"
CDTfolder = CDTname[:-4] + "/"
# print(CDTfolder)
...
#messageID = "20211028141353.A12EBDE048@sub.dom.ain" # Test for reading previous log.imss file
# messageID = "1635427594006111272.5604.5407009073664769857@sub.dom.ain" # Test for reading one log.imss file
# messageID = "9v_5rM_GQYq8sRirj1ghJA@ismtpd0036p1iad1.sendgrid.net" # Test for multiple message IDs
#messageID = "ceb54dd543cc4ce8b2473a8e740c6d57@CRRJ01VS002.dom.local" # Test for next file in log file 41 and 42 (in normal log level)
#messageID = "@dom.ain"  # test with multiple message IDs from lab CDT
messageID = "2025638146.12864930.1633463714549.JavaMail.zimbra@sub.dom.ain"
        ...
        for message in maillog_messages:
            ...
            for new_message in maillog_messages:
                if message.relatedQueueIDs == new_message.maillogQueueIDs:
                    count += 1
                    print("Yes")
                    # Combine maillogs from related messages
    ...
    if result:
        ...
        if not message_starts or message_starts[0][0] > message_IDs[0][0]:
            ...
            if os.path.exists(prev_IMSS_file):
                ...
                logging.info("Previous file not found")
        ...
        if not message_ends or message_ends[-1][0] < message_IDs[-1][0]:
            ...
            if os.path.exists(next_IMSS_file):
                ...
                logging.info("Next file not found")
        else:
...
if __name__ == "__main__":
    ...
    if messages:
        ...
        logging.info("No messages found in IMSS logs")
